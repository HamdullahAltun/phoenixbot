...
exports.run = (client, message, args) => {
  if (message.author.id != "385001389119504384") return message.reply('Bunu Sadece Sahibim Kullanabilir');
  ...
  message.delete();
  message.reply('Mesajını Gönderdim.').then(message => message.delete(5000)); 
