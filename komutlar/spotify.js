...
module.exports.run = async (bot, message, args) => {
    ...
    if (!args[0]) return message.channel.send("**Spotify'dan şarkı dinleyen birini etiketlemen lazım!**")
    ...
    if (user.presence.game.name === 'Spotify' && user.presence.game.type === 2) {
        try {
            ...
            const embed = new Discord.RichEmbed()
                ...
                .setFooter(`Phoenix Gaming ${message.author.username} tarafından istendi.`, "https://cdn.discordapp.com/emojis/515260605347659777.png?v=1")
                .setDescription(`
...
exports.help = {
  name: 'spotify',
  description: 'Belirlenen kişinin spotifyde dinlediği şarkıyı gösterir',
  usage: 'spotify'
};